...
static const char get_time[] = "date '+%Y年%m月%d日(%a) 󱑆 %T'";
...
static const struct arg args[] = {
	...
	{run_command, " 󰏈 %s", get_cpu_temp},
	{ram_perc, " 󰄩 %s%%", NULL},
	{disk_perc, " 󰋊 %s%%", "/"},
	{disk_perc, " 󱂵 %s%%", "/home"},
	{run_command, " 󱌥 %s", get_nvidia_temp},
	{netspeed_rx, " 󰛴 %s", "enp6s0"},
	{netspeed_tx, " 󰛶 %s", "enp6s0"},
	//{ipv4, " \uf26b %s ", "enp6s0"},
	{run_command, "  %s", "amixer | awk -F \"[][]\" ' /Left:/ { print $2 }'"},
